// TODO: power connection, mounting
...
// TODO: check every frame with global variable
void rotateLeft() {
    frontRightMotor.setPower(255);
}
...
void armDown() {
    isMoving = true;
    for(int posDegrees = 180; posDegrees >= servo1.read(); posDegrees--) {
        if (!isMoving) {
            break;
        }
